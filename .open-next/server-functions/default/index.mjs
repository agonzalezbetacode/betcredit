globalThis.monorepoPackagePath = "";globalThis.openNextDebug = false;globalThis.openNextVersion = "3.7.6";
...
var HtmlPages = ["/bets", "/deposits", "/event/[id]", "/", "/events", "/login", "/products", "/signup", "/404"];
